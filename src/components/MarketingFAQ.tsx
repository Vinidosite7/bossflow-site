...
type Item = {
  id: string; // usado no hash: #faq-xxxx
  q: string;
  a: string;
  icon: React.ReactNode;
  popular?: boolean; // "mais visto"
};
...
export default function MarketingFAQ() {
  ...
  // ref dos botões da lista (pra micro-scroll)
  const rowRefs = useRef<Array<HTMLButtonElement | null>>([]);

  // ✅ Deep link: abre pergunta via hash (#faq-xxxx)
  useEffect(() => {
    const applyHash = () => {
  ...
  // micro-scroll quando muda active (sem mudar layout)
  useEffect(() => {
  ...
  // só rola se estiver fora da viewport
...
function IconCard() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="opacity-90">
      ...
      <path
        d="M6 5h12a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V8a3 3 0 0 1 3-3Z"
        stroke="currentColor"
        strokeWidth="2"
...
function IconShield() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="opacity-90">
      <path
        d="M12 3l8 4v6c0 5-3.4 8.7-8 8.7S4 18 4 13V7l8-4Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
...
function IconHeadset() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="opacity-90">
      ...
      <path
        d="M4 14h3v6H6a2 2 0 0 1-2-2v-4Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M20 14h-3v6h1a2 2 0 0 0 2-2v-4Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
